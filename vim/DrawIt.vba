...
let g:loaded_DrawItPlugin = "v14e"
let s:keepcpo             = &cpo
set cpo&vim
...
com! -nargs=0 -range	DIcanvas	call s:Canvas()
...
doc/DrawIt.txt	[[[1
542
DrawIt.txt*	The DrawIt Tool				Dec 12, 2014

Authors:  Charles E. Campbell  <NdrchipO@ScampbellPfamily.AbizM>
          Sylvain Viart             <molo@multimania.com>
	  (remove NOSPAM from Campbell's email first)
Copyright:    Copyright (C) 2004-2014 Charles E. Campbell
	      Permission is hereby granted to use and distribute this code,
	      with or without modifications, provided that this copyright
	      notice is copied with it. Like anything else that's free,
...
2. DrawIt Manual					*drawit* {{{1
 ...
 || \s  |drawit-s| | spacer: appends spaces up to the textwidth (default: 78)  ||
 ||              |                                                           ||
 ++===========+==============================================================++
...
*:DIspacer*  : spacer: appends spaces up to the textwidth (default: 78)
